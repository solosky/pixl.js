...
const char * const lang_en_US[_L_COUNT] = {
    ...
    [_L_APP_SET_STORAGE] = "Ext. Storage",
    ...
    [_L_UPLOAD_KEY_RETAIL_BIN] = "Upload key_retail.bin file to the root directory of the storage",
    [_L_KNOW] = "Understood",
    [_L_RANDOM_GENERATION] = "Randomize Tag",
    [_L_AUTO_RANDOM_GENERATION] = "Auto Randomize",
    [_L_SHOW_QRCODE] = "Show QR Code",
    [_L_DELETE_TAG] = "Delete Tag",
    [_L_DELETE_TAG_CONFIRM] = "Confirm to delete %s ?",
    ...
    [_L_DELETE_ALL_DATA] = "All data will be deleted. Continue?",
    ...
    [_L_NOT_AMIIBO_FILE] = "This is not an Amiibo file",
    [_L_READ_FILE_FAILED] = "Failed read the file",
    [_L_INPUT_FOLDER_NAME] = "Enter Folder Name:",
    [_L_INPUT_AMIIBO_NAME] = "Enter Amiibo Name:",
    ...
    [_L_CREATE_TOO_MANY_NUM] = "Up to %d tags can be created in a batch",
    ...
    [_L_APP_AMIIDB_MORE_MESSAGE] = "Too many results. Try to be more specific.",
    ...
    [_L_APP_AMIIDB_FAV_SUCCESS] = "Added to Favorite",
    [_L_APP_AMIIDB_FAV_FAILED] = "Failed to Favorite!",
    [_L_APP_AMIIDB_SLOT_SAVE_SUCCESS] = "Save Successful",
    ...
    [_L_APP_CHAMELEON_CARD_SET_NICK_SUCCESS] = "Nickname Set",
    [_L_APP_CHAMELEON_CARD_SET_NICK_FAILED] = "Failed!",
    [_L_APP_CHAMELEON_CARD_INPUT_NICK] = "Input Nickname:",
    ...
    [_L_APP_CHAMELEON_CARD_DATA_FACTORY_SUCCESS] = "Data Reset Successful",
