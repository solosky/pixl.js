...
const char * lang_hu_HU[_L_COUNT] = {
    ...
    [_L_APP_SET_RESET_DEFAULT] = "Alapért. Beállítások Visszaállítása",
    [_L_APP_SET_RESET_DEFAULT_SUCCESS] = "Sikeres Visszaállítása!",
    [_L_15S] = "15 sec",
    [_L_30S] = "30 sec",
    [_L_45S] = "45 sec",
    [_L_1MIN] = "1 min",
    ...
    [_L_UPLOAD_KEY_RETAIL_BIN] = "Töltse fel a\nkey_retail.bin\nfájlt a gyökérkönyvtárába.",
    [_L_KNOW] = "Megvan",
    ...
    [_L_TOTAL_SPACE] = "Össz. Lemezterület",
    [_L_AVAILABLE_SPACE] = "Ingyenes Lemezterület",
