...
const char * lang_es_CO[_L_COUNT] = {
    ...
    [_L_APP_CHAMELEON_INITIALIZING] = "Inicializando, por favor espera...",
    ...
    [_L_APP_CHAMELEON_CARD_SET_NICK_SUCCESS] = "Apodo correcto.",
    [_L_APP_CHAMELEON_CARD_SET_NICK_FAILED] = "¡Apodo fallido!",
    ...
    [_L_APP_CHAMELEON_CARD_DATA_FACTORY_SUCCESS] = "Conf. Fabrica Correcta!",
    ...
    [_L_APP_CHAMELEON_CARD_GENERATE_UID] = "Generar UID",
    ...
    [_L_APP_CHAMELEON_CARD_TYPE_FACTORY_DATA_CONFRIM] = "Tipo de tarjeta modificado\nRestablecer datos de la tarjeta?",
};
