...
const char * const lang_de_DE[_L_COUNT] = {
    ...
    [_L_APP_SET_SLEEP_TIMEOUT] = "Energiesparmodus",
    ...
    [_L_UPLOAD_KEY_RETAIL_BIN] = "Platzieren Sie die Datei key_retail.bin im Stammverzeichnis des Speichers.",
    [_L_KNOW] = "Verstanden",
    [_L_RANDOM_GENERATION] = "Zufälliger Tag",
    [_L_AUTO_RANDOM_GENERATION] = "Automatische Zufallsauswahl",
