...
void mui_element_autowrap_text_box(mui_canvas_t *p_canvas, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t offset_y, uint8_t square_r, const char *text);
