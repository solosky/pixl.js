...
///////
#define MAX_PACKET_SIZE 64 //NRF_DRV_USBD_EPSIZE
...
}__attribute__((packed)) mtp_container_header_t;

typedef struct
{
    uint32_t count; /* param count */
    uint32_t parameter[MAX_PARAMETER_COUNT]; /*< parameter */
}__attribute__((packed)) mtp_container_parameter_t;
