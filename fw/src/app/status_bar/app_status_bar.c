...
void app_status_bar_on_run(mini_app_inst_t *p_app_inst) {
    ...
    mui_view_dispatcher_display_view(p_app_handle->p_view_dispatcher, STATUS_BAR_VIEW_ID_MAIN);
}
...
void app_status_bar_on_kill(mini_app_inst_t *p_app_inst) {
    ...
    mui_view_dispatcher_dettach(p_app_handle->p_view_dispatcher, MUI_LAYER_STATUS_BAR);
