...
static void amiibo_detail_view_on_input(mui_view_t *p_view, mui_input_event_t *event) {
    ...
    case INPUT_KEY_LEFT:
        if (p_amiibo_detail_view->event_cb) {
            p_amiibo_detail_view->event_cb(AMIIBO_DETAIL_VIEW_EVENT_PREV, p_amiibo_detail_view);
        }
        break;
    case INPUT_KEY_RIGHT:
        if (p_amiibo_detail_view->event_cb) {
            p_amiibo_detail_view->event_cb(AMIIBO_DETAIL_VIEW_EVENT_NEXT, p_amiibo_detail_view);
        }
        break;
