...
void amiibo_scene_file_browser_menu_on_enter(void *user_data) {
    ...
    mui_list_view_add_item(app->p_list_view, 0xe1c8, "新建Amiibo..", (void *)FILE_BROWSER_MENU_CREATE_AMIIBO);
    ...
    mui_list_view_add_item(app->p_list_view, 0xe069, "返回列表", (void *)FILE_BROWSER_MENU_BACK);
