...
#define NRFX_SPIM_CS_PIN 27 // orange wire (CS)
#define NRFX_SPIM_DC_PIN 28 // green wire (DC)
#define NRFX_SPIM_RESET_PIN 29 // white wire (Reset)
...
void drawLogo(void)
{
    ...
    u8g2_DrawUTF8(&u8g2, 0, 56, "你好世界!塞尔达传说#");
